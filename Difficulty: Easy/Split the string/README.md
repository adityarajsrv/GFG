<h2><a href="https://www.geeksforgeeks.org/problems/split-the-string2424/1?page=2&category=Strings&sortBy=submissions">Split the string</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string S, you have to check if we can split it into four strings such that each string&nbsp;is non-empty and distinct from each other.</span><br>
&nbsp;</p>
